...
const QUESTIONS_MATH_1989 = [
  ...
  { id:'math-1989-9', year:1989, subject:'ma1', topic:'ma-9', type:'single', question:'设向量组α1,α2,α3线性无关，则下列向量组线性相关的是()', options:["A. α1 _ α2  , α2  _ α3 , α3  _ α1","B. α2  + α1  , α2  + α3 , α3  + α1","C. α1 _ 2α2 , α2  _ 2α3 , α3  _ 2α1","D. α1  + 2α2 , α2  + 2α3 , α3  + 2α1"], answer:"" },
  { id:'math-1989-10', year:1989, subject:'ma1', topic:'ma-9', type:'single', question:'设矩阵A则A与B', options:["A. 合同，且相似","B. 合同，但不相似","C. 不合同，但相似","D. 既不合同，也不相似"], answer:"" },
  { id:'math-1989-12', year:1989, subject:'ma1', topic:'ma-8', type:'fill', question:'曲线os2t上对应于t的点处的法线斜率为_____', options:[], answer:"A" },
  { id:'math-1989-13', year:1989, subject:'ma1', topic:'ma-8', type:'fill', question:'设函数y，则y(n)', options:[], answer:"" },
  { id:'math-1989-14', year:1989, subject:'ma1', topic:'ma-8', type:'fill', question:'二阶常系数非齐次线性微分方程y,,_4y,+3y=2e2x的通解为y=', options:[], answer:"" },
